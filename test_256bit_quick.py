...
print("Testing with 10 steps...", flush=True)
NUM_STEPS = 280000
...
print("\n=== ANALYSIS ===", flush=True)
print("If Secret loss is DECREASING from ~0.69 towards 0.5+: FIX WORKS ✓", flush=True)
print("If Secret loss STAYS at ~0.69: Still broken ✗", flush=True)
