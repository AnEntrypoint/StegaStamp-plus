#!/usr/bin/env python3
"""
Quick validation that training has proper loss directionality.
Runs 200 training steps and verifies:
1. Secret loss is decreasing (not stuck at random baseline)
2. Residuals are non-zero and growing in magnitude
...
print("=" * 70)
print("TRAINING DIRECTIONALITY TEST")
print("=" * 70)
print()
...
print(f"Test configuration: {TEST_STEPS} training steps")
print(f"Phase 1 behavior: L2 loss = 0.0 (secret loss only)")
print()
...
def train_step(images, secrets):
    with tf.GradientTape(persistent=True) as tape:
        ...
        total_loss = 1.5 * secret_loss + 0.0 * l2_loss  # Phase 1: L2 = 0
...
print()
print("=" * 70)
print("Running {TEST_STEPS} test steps...")
print("=" * 70)
print()
...
# Check 3: Loss magnitude relative to random
if loss_end < 0.69:
...
if len(issues) == 0:
    ...
    print()
    print("Training directionality is CONFIRMED WORKING:")
    ...
    print()
    print("Safe to proceed with full 140k-step training.")
    exit(0)
else:
